...
<%
	String newFile=request.getParameter("resImg");
RestaurantVO resVo=null;
List<ImageVO>fileList=null;
...
System.out.println(request.getParameter("resName"));
	...
	while(fnames.hasMoreElements()){
			...
			String res_no=mr.getParameter("resNo");
			
			System.out.println(res_name);
			System.out.println(res_tel);
			...
			resVo.setRes_no(Integer.parseInt(res_no));

			int cnt=0;
			
				cnt=resService.updateResImg(resVo, fileList);
