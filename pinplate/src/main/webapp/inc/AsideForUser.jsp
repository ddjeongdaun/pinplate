<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String getMemId=(String)session.getAttribute("mem_id");
%>
...
<hr>
	<ul>
		<li class="categori b mt-3"><a href="<%=request.getContextPath() %>/member/memberInfo.jsp" style="text-decoration: none">
		<span id="numIconOff">
		...
		<li class="categori b"><a href="<%=request.getContextPath() %>/review/reviewForUser.jsp" style="text-decoration: none">
		<span id="numIconOff">
		...
		&nbsp 등록 신청</a>
			<ul>
				<li class="subcategori b mt-3"><a href="<%=request.getContextPath() %>/restaurant/resRegister.jsp" style="text-decoration: none">
				<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
  				<path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"/>
				</svg>
				음식점 등록 신청</a></li>
				<li class="subcategori b mt-3"><a href="<%=request.getContextPath() %>/menu/menuApply.jsp" style="text-decoration: none">
				<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
  				<path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"/>
				</svg>
				메뉴 등록 신청</a></li>
